...
def Assembly_Yield_Simulator(
    ...
    if actual_bitmap_shape != expected_bitmap_shape:
        raise ValueError(
            ...
            "Call update_config_items() before pad_bitmap_generate(), and regenerate "
            "the bitmap after changing die size or pitch."
        )
    ...
    for i in range(cfg.simulation_times):
        ...
        waf_list = wafer_initialize(
            ...
            pad_yield_flag       = cfg.pad_yield_flag or cfg.approximate_set == 1,
        )
